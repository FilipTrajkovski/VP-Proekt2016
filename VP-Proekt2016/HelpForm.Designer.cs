namespace VP_Proekt2016
{
    partial class HelpForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label2.Text = "The classic Sudoku game involves a grid of 81 squares. The grid is divided into n" +
    "ine blocks, each containing nine squares.";
            // 
            // label3
            // 
            ...
            this.label3.Text = "The rules of the game are simple: each of the nine blocks has to contain all the " +
    "numbers 1-9 within its squares. Each number can only appear once in a row, colum" +
    "n or box.";
            // 
            // label4
            // 
            ...
            this.label4.Text = "The difficulty lies in that each vertical nine-square column, or horizontal nine-" +
    "square line across, within the larger square, must also contain the numbers 1-9," +
